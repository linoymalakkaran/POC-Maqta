...
@Component({
  selector: 'airway',
  templateUrl: './airway.component.html',
  styleUrls: ['./airway.component.scss']
})
export class AirwayComponent implements OnInit {
  ...
  private get icons(): Array<string> {
    return ['close-white-icon', 'filter-icon', 'plus-white', 'open-table-icon', 'soc-icon', 'download-icon', 'folder'];
  }
