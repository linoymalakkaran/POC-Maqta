...
@Component({
    selector       : 'atlp-navigation',
    templateUrl    : './navigation.component.html',
    styleUrls      : ['./navigation.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AtlpNavigationComponent implements OnInit
{
    @Input()
    layout = 'vertical';
    ...
    ngOnInit(): void
    {
        ...
        this.navigation = this.navigation || this._atlpNavigationService.getCurrentNavigation();
