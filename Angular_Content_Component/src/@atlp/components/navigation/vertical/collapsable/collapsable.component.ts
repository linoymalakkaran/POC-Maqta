...
@Component({
    selector   : 'atlp-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : AtlpAnimations
})
export class AtlpNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._atlpNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._atlpNavigationService.onItemCollapsed.next(this.item);
        this._atlpNavigationService.onItemCollapseToggled.next();
    }
