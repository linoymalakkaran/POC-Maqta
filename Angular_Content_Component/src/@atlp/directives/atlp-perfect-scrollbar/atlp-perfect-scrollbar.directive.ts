...
import { AtlpPerfectScrollbarGeometry, AtlpPerfectScrollbarPosition } from '@atlp/directives/atlp-perfect-scrollbar/atlp-perfect-scrollbar.interfaces';
import { AtlpConfigService } from '@atlp/services/config.service';

@Directive({
    selector: '[atlpPerfectScrollbar]'
})
export class AtlpPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
